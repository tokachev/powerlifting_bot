...
/predict — план следующей тренировки по последним 30 тренировкам через Codex
/charts — список графиков из dashboard
/chart <id> [lift] [weeks] — прислать график картинкой
/delete_last — удалить последнюю тренировку
/edit_last <текст> — заменить последнюю тренировку
/add <текст> — дописать упражнения к последней тренировке
